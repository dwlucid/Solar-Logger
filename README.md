## Builder Preview
![preview]([https://user-images.githubusercontent.com/75003671/120157017-26796300-c225-11eb-8f84-7428165ca672.gif](https://prnt.sc/xAyyArdEsdiy))
...
Google Chrome always store user data in the same place, so the stealer generated by Solqr Grabber has no problem in finding it. In theory at least, this data is stored in encrypted form. However, if the malware has already penetrated the system, then its actions are done in your name.
